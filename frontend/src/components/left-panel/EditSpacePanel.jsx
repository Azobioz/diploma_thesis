...
const EditSpacePanel = ({
    ...
    const [spaceDescription, setSpaceDescription] = useState(initialDescription);
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            setSpaceDescription(initialDescription);
    ...
    const validateSpaceName = (name) => {
        if (!name.trim()) return 'Название не может быть пустым';
    ...
    const isConfirmDisabled = !spaceName.trim() || errors.spaceName || errors.spaceDescription;

    if (!isOpen) return null;

    return (
        <div className="edit-space-overlay">
            <div className="edit-space-panel" ref={panelRef}>
                ...
                <div className="panel-buttons">
                    ...
                    <button
                        className={`btn-confirm-create-space ${isConfirmDisabled ? 'btn-disabled' : ''}`}
